...
export class Game {
    ...
    music = localStorageInstance.config.oldMenuMusic ? new Howl({ src: "./audio/music/old_menu_music.mp3", loop:true }) : new Howl({ src: "./audio/music/menu_music.mp3", loop:true });
    musicPlaying = false;
