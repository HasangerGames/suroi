...
class MapManagerClass {
    ...
    resize(): void {
        ...
        if (this._expanded) {
            ...
            this._margins = Vec(screenWidth / 2 - (this._minimapWidth / 2), screenHeight / 2 - (this._minimapHeight / 2));
            ...
            this._margins = Vec(bounds.left + border, bounds.top + border);
