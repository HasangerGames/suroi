...
export const HUNGARIAN_TRANSLATIONS: TranslationMap = {
    ...
    kf_two_party_kill: "<player> megölte <victim>",
    kf_two_party_down: "<player> kiütötte <victim>",
    kf_bleed_out_kill: "<player> kivérzett",
    kf_bleed_out_down: "<player kivérzett nem halálosan",
    kf_finished_off_kill: "<player> kivégezte <victim>",
    kf_finished_off_down: "<player> finoman kivégezte <victim>",
    ...
    kf_finally_down: "<player> végleg kiütötték",
