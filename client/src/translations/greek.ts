...
export const GREEK_TRANSLATIONS: TranslationMap = {
    ...
    "settings_hide_emotes": "Απόκρυψη των emotes",
    ...
    "tt_reduces": "<item> μειώνει την καταστροφή κατά <percent>%",

    "go_kills": "Σκοτωμοί:",
    // "go_damage_done": "Καταστροφή που έκανες:",
    // "go_damage_taken": "Καταστροφή που δέχτηκες:",
    ...
    "bag": "Τσάντα", // This shouldn't show up in game
    "basic_pack": "Βασικό Σακίδιο",
    "regular_pack": "Κανονικό Σακίδιο",
    "tactical_pack": "Τακτικό Σακίδιο",

    "1x_scope": "1x Πεδίο", // This shouldn't show up in game
    "2x_scope": "2x Πεδίο",
    "4x_scope": "4x Πεδίο",
    "8x_scope": "8x Πεδίο",
    "15x_scope": "15x Πεδίο",
