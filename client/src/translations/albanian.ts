...
export default defineLanguage("Shqip", "🇦🇱", {
    ...
    "msg_punishment_warn": "Ju jeni paralajmëruar!",
    "msg_punishment_warn_reason": "Ju keni marrë një paralajmërim nga moderatorët për arsye: <reason>",
    "msg_punishment_temp": "Ju jeni ndaluar përkohësisht!",
    "msg_punishment_temp_reason": "Ju jeni ndaluar për arsye: <reason>",
    "msg_punishment_perma": "Ju jeni ndaluar përgjithmonë!",
    "msg_punishment_perma_reason": "Ju jeni ndaluar për arsye: <reason>",
