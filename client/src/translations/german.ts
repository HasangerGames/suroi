...
export const GERMAN_TRANSLATIONS: TranslationMap = {
    ...
    "msg_punishment_warn": "Du wurdest verwarnt!",
    "msg_punishment_warn_reason": "Du wurdest von den Moderatoren wegen folgendem Grund verwarnt: <reason>",
    "msg_punishment_temp": "Du wurdest vorübergehend gesperrt!",
    "msg_punishment_temp_reason": "Du wurdest wegen folgendem Grund gesperrt: <reason>",
    "msg_punishment_perma": "Du wurdest dauerhaft gesperrt!",
    "msg_punishment_perma_reason": "Du wurdest wegen folgendem Grund gesperrt: <reason>",
