...
export const FRENCH_TRANSLATIONS: TranslationMap = {
    ...
    "settings_hide_rules": "Flouter splash screen",
    ...
    "settings_scope_looping": "Faire boucler la sélection de pointeurs",
    "settings_draw_hud": "Montrer le HUD",
    "settings_autopickup": "Activer récupération auto",
    ...
    "settings_joystick_size": "Taille des joystick",
    "settings_joystick_opacity": "Opacité des joystick",
    ...
    "loading_spritesheets": "Chargement des Spritesheets <progress>",
    "loading_connecting": "Connexion",
    "loading_joining_game": "Connexion a la partie...",
    ...
    "bindings_loot": "Looter",
    "bindings_slot 0": "Equiper l'arme primaire",
    "bindings_slot 1": "Equiper l'arme secondaire",
    "bindings_slot 2": "Equiper l'arme de mêlée",
    "bindings_equip_or_cycle_throwables 1": "Equiper/Changer de Projectile",
    "bindings_last_item": "Equiper la dernière arme",
    "bindings_other_weapon": "Equiper l'autre arme",
    "bindings_swap_gun_slots": "Echanger les slots d'arme",
    "bindings_cycle_items -1": "Equiper l'arme précédente",
    "bindings_cycle_items 1": "Equiper l'arme suivante",
    ...
    "kf_finished_off_kill": "<player> a éxécuté <victim>",
    ...
    "kf_gas_kill": "<player> a été asphyxyié par le gas",
    ...
    "tt_reduces": "<item> réduit <percent>% de dégats",

    "go_kills": "Kills:",
    "go_damage_done": "Dégats faits:",
    "go_damage_taken": "Dégats pris:",
    "go_time_alive": "Temps vivant:",

    "create_team": "Créer son équipe",
    "create_team_autofill": "Remplissage auto",
    "create_team_lock": "Verouiller l'équipe",
    ...
    "confetti_grenade": "Grenade Confetti",
