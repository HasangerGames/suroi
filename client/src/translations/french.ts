...
export const FRENCH_TRANSLATIONS: TranslationMap = {
    ...
    "settings_save_load": "Sauvegarder/Charger",
    "settings_mobile": "Mobile",
    "settings_require_reload": "* Changer ces paramètres requiert un rafraîchissement de la page",
    "settings_performance_warning": "* Ce paramètre peut causer des problèmes sur certaines machines. Désactivez-le si rejoindre un match devient impossible.",
