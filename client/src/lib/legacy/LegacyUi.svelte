...
<div id="console" class="floating-window" style="display: none">
  <div id="console-container" class="floating-window-container">
    <div id="console-header" class="floating-window-header">
      <span>Console</span>
      <button id="console-close" class="floating-window-close"><X /></button>
    </div>
...
<!-- Debug Menu --->
<div id="debug-menu" class="floating-window" style="display: none;">
  <div id="debug-menu-container" class="floating-window-container">
    <div id="debug-menu-header" class="floating-window-header">
      <span>Debug Menu</span>
      <button id="debug-menu-close" class="floating-window-close"><i class="fa-solid fa-xmark"></i></button>
    </div>
    <div id="debug-menu-content"></div>
  </div>
</div>

<!-- Main UI -->
<div id="splash-ui" style="display: none">
  ...
  <div id="splash-modals">
    ...
    <div id="splash-news" class="persistent-scrollbar">
      ...
      <div id="news-posts">%NEWS%</div>
    </div>

    <!-- Center pane -->
    <div id="splash-center">
      <!-- Marquee -->
      <div class="marquee-container"><div class="marquee-content"></div></div>
      ...
      <div id="splash-options" class="loading">
        ...
        <div id="splash-options-wrapper">
          ...
          <div id="server-select" class="dropdown">
            <button id="btn-server-select">
              ...
              <span style="margin-left: auto">
                <img src={asset("/img/misc/player_icon.svg")} width="16" height="16" alt="Player count" />
          ...
          <button class="btn btn-lg btn-darken btn-secondary" id="btn-rules" style="display: none">
            ...
            <div class="btn-darken" id="rules-close-btn" style="display: none">
      ...
      <div class="featured-container">
        ...
        >
          <img
            ...
            src={asset("/img/misc/youtube-icon.svg")}
            alt="YouTube icon"
            width="36"
            height="25"
          />
      ...
      <div class="featured-container">
        ...
        >
          <img
            ...
            src={asset("/img/misc/twitch-icon.svg")}
            alt="Twitch icon"
            width="26.333"
            height="30"
          />
...
<div id="game">
  <div id="game-ui">
    ...
    <div id="top-left-container">
      ...
      <div id="mobile-options" style="display: none">
        ...
        <button id="btn-emotes" class="btn btn-lg btn-primary">
          <img src={asset("/img/misc/emotes_icon.svg")}/>
        </button>
      ...
      <div id="gas-and-debug">
        <div id="gas-timer">
          <img id="gas-timer-image" src={asset("/img/misc/gas-waiting-icon.svg")} />
    ...
    <div class="ui-leaderboard">
      ...
      <div id="counter-holder">
        <div class="counter" id="kill-counter">
          <img src={asset("/img/misc/skull_icon.svg")} />
          <div class="counter-text" id="ui-kills">0</div>
        </div>
        <div class="counter">
          <img src={asset("/img/misc/player_icon.svg")} />
    ...
    <div id="c4-detonate-btn">
      <img class="item-image" src={asset("/img/misc/c4-explode.svg")} draggable="false">
    ...
    <div id="game-over-overlay" style="display: none">
      ...
      <div id="game-over-top-screen">
        <img id="chicken-dinner" src={asset("/img/game/emotes/chicken_dinner.svg")}>
...
<div class="modal dialog" id="settings-menu" style="display: none">
  ...
  <div id="settings-tabs-container">
    ...
    <div class="tab-bar" id="settings-tab-bar">
      ...
      <button class="tab" id="tab-cooler-graphics"><i class="fa-solid fa-wand-magic-sparkles"></i><span translation="settings_cooler_graphics"></span></button>
    ...
    <div id="settings-tabs" class="persistent-scrollbar">
      ...
      <!-- Cooler graphics tab -->
      <div class="tab-content" id="tab-cooler-graphics-content" style="display: none">
        <div class="modal-item checkbox-setting">
          <label>
        ...
        <div class="modal-item checkbox-setting" style="margin-left: 20px;">
          <label>
            <span class="setting-title" translation="settings_explosion_shockwaves"></span>
            <input type="checkbox" id="toggle-cooler-explosions">
          </label>
        </div>
        <div class="modal-item checkbox-setting" style="margin-left: 20px;">
          <label>
            <span class="setting-title" translation="settings_bullet_trail_bloom"></span>
            <input type="checkbox" id="toggle-cooler-bullet-trails">
          </label>
        </div>
        <div class="modal-item checkbox-setting" style="margin-left: 20px;">
          <label>
            <span class="setting-title" translation="settings_blood_splatter"></span>
            <input type="checkbox" id="toggle-cooler-blood">
          </label>
        </div>
        <div class="modal-item checkbox-setting" style="margin-left: 20px;">
          <label>
            <span class="setting-title" translation="settings_cooler_weapon_gas"></span>
            <input type="checkbox" id="toggle-cooler-weapon-gas">
          </label>
        </div>
      </div>
      ...
      <div class="tab-content" id="tab-interface-content" style="display: none">
        ...
        <div class="modal-item checkbox-setting" style="display: none">
          <label>
            <span class="setting-title" translation="settings_hide_qq">Hide the QQ social media button</span>
            <input type="checkbox" id="toggle-hide-qq">
          </label>
        </div>
        <div class="modal-item checkbox-setting">
          <label>
        ...
        <div class="modal-item checkbox-setting">
          <label>
            <span class="setting-title" translation="settings_weapon_compare">Pickup weapon comparison</span>
            <input type="checkbox" id="toggle-weapon-comparison">
          </label>
        </div>
        <div class="modal-item checkbox-setting">
          <label>
            <span class="setting-title" translation="settings_weapon_compare_condensed">Condensed pickup stats</span>
            <input type="checkbox" id="toggle-weapon-comparison-condensed">
          </label>
        </div>
        <div class="modal-item checkbox-setting">
          <label>
      ...
      <div class="tab-content" id="tab-mobile-content" style="display: none">
        ...
        <div class="modal-item checkbox-setting">
          <label>
              <span class="setting-title" translation="settings_shake_to_reload"></span>
              <input type="checkbox" id="toggle-shake-to-reload">
          </label>
        </div>
        <div class="modal-item">
          <label>
              <span class="setting-title" translation="settings_shake_count"></span>
              <span class="range-input-value"></span>
              <input type="range" max="10" min="2" id="slider-shake-count" step="1">
          </label>
        </div>
        <div class="modal-item">
          <label>
              <span class="setting-title" translation="settings_shake_force"></span>
              <span class="range-input-value"></span>
              <input type="range" max="30" min="1" id="slider-shake-force" step="1">
          </label>
        </div>
        <div class="modal-item">
          <label>
              <span class="setting-title" translation="settings_shake_delay"></span>
              <span class="range-input-value"></span>
              <input type="range" max="500" min="10" id="slider-shake-delay" step="10">
          </label>
        </div>
        <div class="modal-item checkbox-setting">
          <label>
...
<div class="modal dialog persistent-scrollbar" id="customize-menu" style="display: none">
  ...
  <div id="customize-tabs-container">
    ...
    <div class="tab-bar" id="customize-tab-bar">
      ...
      <button class="tab" id="tab-emotes"><img src={asset("/img/misc/emotes_icon.svg")}><span translation="loadout_emotes"></span></button>
      <button class="tab" id="tab-crosshairs"><img src={asset("/img/misc/crosshair_icon.svg")}><span translation="loadout_crosshairs"></span></button>
      ...
      <div class="tab-content" id="tab-emotes-content" style="display: none">
        <div id="emote-wheel-container">
          <div id="emote-customize-wheel">
            <div class="emote-top emote-display"></div>
            <div class="emote-right emote-display"></div>
            <div class="emote-bottom emote-display"></div>
            <div class="emote-left emote-display"></div>
            <div class="emote-extra1 emote-display">
              <i class="fa-solid fa-trash" title="Remove emote"></i>
            </div>
            <div class="emote-extra2 emote-display">
              <i class="fa-solid fa-trash" title="Remove emote"></i>
            </div>
          </div>
          <div id="emote-wheel-bottom">
            <div class="emote-win emote-display">
              <i class="fa-solid fa-crown"></i>
              <i class="fa-solid fa-trash" title="Remove emote"></i>
            </div>
            <div class="emote-death emote-display">
              <img src={asset("/img/misc/skull_icon.svg")} />
              <i class="fa-solid fa-trash" title="Remove emote"></i>
            </div>
          </div>
...
<div class="modal dialog" id="partners-modal" style="display: none">
  ...
  <div id="partners-list" class="persistent-scrollbar">
    ...
    <a style="color:lightgreen;text-decoration:none">CrawMusic Records</a>
    <a href="https://iogames.games" target="_blank">iogames.games</a>
    <a href="https://io-games.onl" target="_blank">io-games.onl</a>
    <a href="https://io-games.onl" target="_blank">iogames.onl</a>
    ...
    <a href="https://wackagames.com" target="_blank">WackaGames</a>
  </div>
  <div id="partners-contact">
    <span translation="msg_contact"></span>
    <a class="btn btn-primary" href="mailto:support@suroi.io" translation="contact"></a>
  </div>
</div>
