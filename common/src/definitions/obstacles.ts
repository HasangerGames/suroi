...
import { CircleHitbox, GroupHitbox, type Hitbox, RectangleHitbox } from "../utils/hitbox";
...
export const Obstacles = new ObjectDefinitions<ObstacleDefinition>(([
    ...
    {
        idString: "cargo_ship_stair_entrance",
