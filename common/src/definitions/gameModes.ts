import { GameMode } from "../schemas/misc";
...
export type SpritesheetNames = GameMode | "shared";
...
const normalColors: GameModeDefinition["colors"] = {
    grass: "hsl(95, 41%, 38%)",
    water: "hsl(211, 63%, 42%)",
...
export const GameModes: Record<GameMode, GameModeDefinition> = {
    ...
    nye: {
        ...
        bulletFilters: true,
        playButton: {
            image: "/img/game/obstacles/christmas_tree/christmas_tree.svg",
        },
        canvasFilters: {
            brightness: 0.6,
            saturation: 0.85
