    ...
    { // implemented by pap with a lot of love >w<
        ...
        groundGraphics: [
            ...
            },
            {
                color: 0x705136,
                hitbox: new PolygonHitbox([
                    Vec.create(86.7, 2.92),
                    Vec.create(66.13, -16.57),
                    Vec.create(65.5, -18.38),
                    Vec.create(65.21, -20.26),
                    Vec.create(65.32, -22.74),
                    Vec.create(65.84, -25.02),
                    Vec.create(66.78, -27.08),
                    Vec.create(68.03, -28.71),
                    Vec.create(69.66, -30.09),
                    Vec.create(71.78, -31.23),
                    Vec.create(74.26, -31.93),
                    Vec.create(76.83, -32.35),
                    Vec.create(79.6, -32.33),
                    Vec.create(82.35, -32.19),
                    Vec.create(84.81, -31.79),
                    Vec.create(87.47, -31.12),
                    Vec.create(89.84, -30.29),
                    Vec.create(91.91, -29.33),
                    Vec.create(93.82, -28.22),
                    Vec.create(95.54, -26.94),
                    Vec.create(97.21, -25.29),
                    Vec.create(98.34, -23.89),
                    Vec.create(99.43, -22.21),
                    Vec.create(100.26, -20.51),
                    Vec.create(100.98, -18.48),
                    Vec.create(101.48, -16.42),
                    Vec.create(101.88, -14.34),
                    Vec.create(102.1, -12.69),
                    Vec.create(102.33, -10.32),
                    Vec.create(102.23, -8.19),
                    Vec.create(101.85, -6.16),
                    Vec.create(101.24, -4.21),
                    Vec.create(100.22, -2.6),
                    Vec.create(98.79, -1.19),
                    Vec.create(96.7, 0.15),
                    Vec.create(94.83, 1),
                    Vec.create(92.47, 1.59),
                    Vec.create(90.32, 2.09),
                    Vec.create(88.35, 2.6),
                    Vec.create(66.84, -15.04),
                    Vec.create(85.17, 3.26),
                    Vec.create(83.29, 3.49),
                    Vec.create(81.42, 3.58),
                    Vec.create(79.46, 3.5),
                    Vec.create(77.71, 2.94),
                    Vec.create(76.28, 2.02),
                    Vec.create(75.16, 0.66),
                    Vec.create(74.23, -0.73),
                    Vec.create(73.32, -2.44),
                    Vec.create(72.63, -4.06),
                    Vec.create(71.55, -6.63),
                    Vec.create(70.43, -9.39),
                    Vec.create(68.99, -11.43),
                    Vec.create(67.64, -13.53)
                ])
            },
            {
                color: 0x5e442e,
