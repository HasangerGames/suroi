        ...
        return [
            ...
            },
            {
                ...
                obstacles: [
                    ...
                    { idString: "regular_crate", position: Vec.create(34.57, -20.63) },
                    { idString: "ammo_crate", position: Vec.create(24.51, -20.63) },
                    { idString: "pallet", position: Vec.create(18.07, -4.83), rotation: 1 },
                    { idString: "gun_case", position: Vec.create(18.07, -4.83), rotation: 1 },
                    { idString: { melee_crate: 1, grenade_crate: 0.5 }, position: Vec.create(17.2, 21.54) },
                    { idString: { box: 1, grenade_box: 0.6 }, position: Vec.create(16.52, -23) },
                    { idString: { box: 1, grenade_box: 0.6 }, position: Vec.create(16.52, -18.2) },
                    { idString: { grenade_box: 2, box: 0.5 }, position: Vec.create(16.45, 14.61) },
