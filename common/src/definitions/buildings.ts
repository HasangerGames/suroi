...
export const Buildings = ObjectDefinitions.create<BuildingDefinition>()(
    defaultTemplate => ({
        ...
        tugboat: (color: string, mainLoot: string) => ({
    ...
    ({ simple }) => [
        ...
        simple("port_warehouse", "red", 0x813131),
        simple("port_warehouse", "blue", 0x2e2e6a),
        {
            idString: "refinery",
            name: "Refinery",
            material: "stone",
        ...
        simple("blueHouseVaultLayout", 3, [
            { idString: "box", position: Vec.create(12.5, 11.6) },
            { idString: "box", position: Vec.create(12.5, 16.6) },
            { idString: "box", position: Vec.create(17.5, 16.6) }
        ]),

        simple("blueHouseVaultLayout", 4, [
            { idString: "gun_case", position: Vec.create(12.5, 14.1), rotation: 1 },
            { idString: "box", position: Vec.create(18.1, 11.6) }
        ]),
        ...
        }, */ // TODO: add on v0.19.1 and rework layout
        {
            ...
            obstacles: [
                ...
                { idString: "house_wall_15", position: Vec.create(13.38, 5.6), rotation: 0 },
                { idString: "house_wall_14", position: Vec.create(6.3, 13.1), rotation: 1 },
                { idString: "metal_door", position: Vec.create(26.15, 4.9), rotation: 2 },
        ...
        simple("tugboat", "red", "lux_crate"),
        simple("tugboat", "white", "gun_case"),
        {
        ...
        },
        {
            ...
            obstacles: [
                ...
                { idString: "headquarters_wall_10", position: Vec.create(3.1, -15.57), rotation: 1 },
                { idString: "headquarters_wall_10", position: Vec.create(25.5, -15.57), rotation: 1 },
                { idString: "headquarters_wall_10", position: Vec.create(48, -15.57), rotation: 1 },
                ...
                { idString: "headquarters_wall_13", position: Vec.create(3, 25.25), rotation: 1 },
                ...
                { idString: "headquarters_wall_11", position: Vec.create(50.05, 10), rotation: 0 },
                ...
                { idString: "stove", position: Vec.create(47.5, -101.5), rotation: 0 },
            ...
            subBuildings: [
                ...
                { idString: "headquarters_second_floor_2", position: Vec.create(5.6, -0.6), layer: 2 },
        ...
        {
            idString: "headquarters_second_floor_2",
            name: "Headquarters Second Floor",
            material: "stone",
            particle: "hq_stone_wall_particle",
            particleVariations: 2,
            hi2tbox: new GroupHitbox(
                // outer
            ...
            obstacles: [
                ...
                { idString: "headquarters_wall_7", position: Vec.create(-32.58, -54.5), rotation: 0 },
                ...
                { idString: "bookshelf", position: Vec.create(11, -59.5), rotation: 0 },
