        ...
        return [
            ...
            },
            {
                ...
                obstacles: [
                    ...
                    // pumpkin patch
                    { idString: "pumpkin", position: Vec.create(29.28, 42.31) },
                    { idString: "pumpkin", position: Vec.create(36.33, 58.28) },
                    { idString: "pumpkin", position: Vec.create(47.93, 41.6) },
                    { idString: "pumpkin", position: Vec.create(33.43, 23.17) },
                    { idString: "pumpkin", position: Vec.create(1.68, 39.19) },
                    { idString: "pumpkin", position: Vec.create(-8.69, 67.17) },
                    { idString: "pumpkin", position: Vec.create(-27.85, 49.54) },
                    { idString: "pumpkin", position: Vec.create(-22.54, 72.92) },
                    { idString: "pumpkin", position: Vec.create(-36.98, 80.76) },
                    { idString: "pumpkin", position: Vec.create(-16.84, 93.98) },
                    { idString: "pumpkin", position: Vec.create(-49.4, 81.28) },
                    { idString: "pumpkin", position: Vec.create(-66.76, 103.4) },
                    { idString: "pumpkin", position: Vec.create(-32.25, 123.85) },
                    { idString: "pumpkin", position: Vec.create(-34.24, 143.81) },
                    { idString: "pumpkin", position: Vec.create(-3.59, 132.6) },
                    { idString: "pumpkin", position: Vec.create(-12.84, 159.58) },
                    { idString: "pumpkin", position: Vec.create(25.88, 133.68) },
                    { idString: "pumpkin", position: Vec.create(17.79, 155.24) },
                    { idString: "pumpkin", position: Vec.create(51.1, 156.83) },
                    { idString: "pumpkin", position: Vec.create(42.32, 124.3) },
                    { idString: "pumpkin", position: Vec.create(69.76, 126.72) },
                    { idString: "pumpkin", position: Vec.create(49.68, 108.95) },
                    { idString: "pumpkin", position: Vec.create(75.76, 102.93) },
                    { idString: "pumpkin", position: Vec.create(98.99, 82.36) },
                    { idString: "pumpkin", position: Vec.create(80.34, 68.92) },
                    { idString: "pumpkin", position: Vec.create(56.55, 85.49) },
                    { idString: "pumpkin", position: Vec.create(77.99, 40.08) },
                    { idString: "pumpkin", position: Vec.create(103.14, 68.85) },
                    { idString: "pumpkin", position: Vec.create(99.79, 121.9) },
                    { idString: "pumpkin", position: Vec.create(90.43, 165.61) },
                    { idString: "pumpkin", position: Vec.create(59.25, 173.26) },
                    { idString: "pumpkin", position: Vec.create(20.76, 170.1) },
                    { idString: "pumpkin", position: Vec.create(-13.64, 182.08) },
                    { idString: "pumpkin", position: Vec.create(-25.67, 157.14) },
                    { idString: "pumpkin", position: Vec.create(-16.86, 28.72) },
                    { idString: "pumpkin", position: Vec.create(-46.1, 48) },
                    { idString: "pumpkin", position: Vec.create(-63.27, 129.08) },
                    { idString: "pumpkin", position: Vec.create(-60.49, 165.64) }
                ],
                subBuildings: [
