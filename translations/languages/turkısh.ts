...
export default defineLanguage("Turkısh", "🇹🇷", {
    ...
    "msg_punishment_warn": "Uyarıldın!",
    "msg_punishment_warn_reason": "Moderatörler tarafından bir sebepten dolayı uyarı aldınız: <reason>",
    "msg_punishment_temp": "Geçici olarak yasaklandınız!",
    "msg_punishment_temp_reason": "Şu sebeple yasaklandınız: <reason>",
    "msg_punishment_perma": "Kalıcı olarak yasaklandın!",
    "msg_punishment_perma_reason": "Nedeniyle yasaklandınız: <reason>",
    ...
    "destroyer_of_worlds": "Dünyaların Yok Edicisi",
    "revitalizer": "Canlandırıcı",
    "g17_scoped": "G17 (Dürbünlü)",
    "vss": "VSS",
    "aug": "AUG",
    "pp19": "PP-19",
    "vepr12": "Vepr-12",
