...
export default defineLanguage("Cute Engwish", "🎀", {
    ...
    "msg_punishment_warn": "You have been wawned owo!",
    "msg_punishment_warn_reason": "You hab weceived a wawning by da modewatows fow weason: <reason>",
    "msg_punishment_temp": "You hab been tempowawiwy banned!",
    "msg_punishment_temp_reason": "You hab been banned fow weason: <reason>",
    "msg_punishment_perma": "You hab been pewmanentwy banned! ToT",
    "msg_punishment_perma_reason": "You hab been banned fow weason: <reason>",
