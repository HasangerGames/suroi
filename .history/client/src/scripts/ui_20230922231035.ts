...
export function setupUI(game: Game): void {
  ...
  <span class="emote-name">${emote.name}</span>
    ...
    for (const crosshair of Crosshairs.definitions) {
        ...
        <div class="crosshairs-list-item" style="background-image: url('/img/game/crosshairs/${crosshair.idString}.svg'); background-size: cover; background-repeat: no-repeat;"></div>
