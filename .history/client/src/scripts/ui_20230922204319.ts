...
export function setupUI(game: Game): void {
  ...
  <span class="emote-name">${emote.name}</span>
    ...
    for (const crosshair of Crosshairs.definitions) {
        const crosshairItem = $(`<div id="crosshair-${crosshair.idString}" class="crosshairs-list-item-container">
        <div class="crosshairs-list-item" style="background-image: url('/img/game/crosshairs/${crosshair.idString}.svg
        `);
    }
