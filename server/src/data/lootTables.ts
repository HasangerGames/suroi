...
export const LootTables: Record<string, Record<string, LootTable>> = {
    ...
    fall: {
        ...
        guns: [
            ...
            { item: "model_37", weight: 0.5 },
            { item: "dual_m1895", weight: 0.5 },
            { item: "m3k", weight: 0.1 },
            { item: "cz600", weight: 0.1 },
            { item: "flues", weight: 0.1 },
            { item: "sr25", weight: 0.03 },
            { item: "mini14", weight: 0.03 },
            { item: "mosin_nagant", weight: 0.03 },
        ...
        special_guns: [
            ...
            { item: "sr25", weight: 0.075 },
            { item: "mini14", weight: 0.075 },
            { item: "mosin_nagant", weight: 0.075 },
            { item: "m590m", weight: 0.05 },
            { item: "model_89", weight: 0.05 },
            { item: "vepr12", weight: 0.05 },
