...
import { MapPacket, type MapPacketData } from "../../common/src/packets/mapPacket";
...
import { type Mutable, type SMutable } from "../../common/src/utils/misc";
    ...
    generateBuilding(
        ...
        for (const obstacleData of definition.obstacles) {
            ...
            const obstacle = this.generateObstacle(
                ...
                obstacleRotation,
                obstacleData.layer ?? definition.layer,
